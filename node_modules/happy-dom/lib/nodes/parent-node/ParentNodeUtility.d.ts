...
export default class ParentNodeUtility {
     ...
     */
    static getElementsByClassName(parentNode: IElement | IDocumentFragment | IDocument, className: string): IHTMLCollection<IElement, IElement>;
    /**
     ...
     * @returns Matching element.
     */
    static getElementsByTagName(parentNode: IElement | IDocumentFragment | IDocument, tagName: string): IHTMLCollection<IElement, IElement>;
    /**
     ...
     * @returns Matching element.
     */
    static getElementsByTagNameNS(parentNode: IElement | IDocumentFragment | IDocument, namespaceURI: string, tagName: string): IHTMLCollection<IElement, IElement>;
    /**
