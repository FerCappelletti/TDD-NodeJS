...
export default class Document extends Node implements IDocument {
     ...
     * @returns Scripts.
     */
    get scripts(): IHTMLCollection<IHTMLScriptElement, IHTMLScriptElement>;
    /**
     * Returns base URI.
     *
     * @override
     ...
     * @returns Matching element.
     */
    getElementsByTagNameNS(namespaceURI: string, tagName: string): IHTMLCollection<IElement, IElement>;
    /**
